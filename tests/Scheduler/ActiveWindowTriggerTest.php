...
final class ActiveWindowTriggerTest extends TestCase
{
    ...
    public function testARunDateOutsideTheWindowIsPushedToTheFirstCycleAfterTheReopening(): void
    {
        ...
        $nextRun = $trigger->getNextRunDate(self::instantAt('2026-08-03 07:05:00'));

        self::assertSame('2026-08-03 09:05:00', self::formatInParis($nextRun));
    }

    public function testACycleLandingOnTheOpeningFiresAtTheOpening(): void
    {
        $cycleAlignedOnTheOpening = new PeriodicalTrigger('15 minutes', self::instantAt('2026-08-03 06:00:00'));
        $trigger = new ActiveWindowTrigger($cycleAlignedOnTheOpening, ActiveWindowFactory::marketWindowIn('Europe/Paris'));

        $nextRun = $trigger->getNextRunDate(self::instantAt('2026-08-03 07:00:00'));

        self::assertSame('2026-08-03 09:00:00', self::formatInParis($nextRun));
    }
    ...
    public function testAFridayEveningRunDateLandsOnMondayMorning(): void
    {
        ...
        self::assertSame('2026-08-10 09:00:00', self::formatInParis($nextRun));
    }
